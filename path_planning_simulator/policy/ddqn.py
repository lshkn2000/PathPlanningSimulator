...
class DDQN(Policy):
    def __init__(self, observation_space, action_space, gamma, lr):
        ...
        # nn model
        self.online_model = FCQ(observation_space, action_space, hidden_dims=(512, 128))
        self.target_model = FCQ(observation_space, action_space, hidden_dims=(512, 128))
        self.update_network()  # target_network 파라미터를 online network와 동일하게 복사
