...
def vae_train():
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        # best_filename = os.path.join(vae_model_dir, 'monkey5_best.tar')
        # file_name = os.path.join(vae_model_dir, 'monkey5_checkpoint.tar')
    ...
    # LATENT_DATASET = os.path.join(PATH, r'utils/world_model/VAE/vae_models/monkey5_latent_dataset.pkl')
...
# torchvision.utils.save_image(compare_x.data.cpu(), 'monkey5_sample_image.png')
